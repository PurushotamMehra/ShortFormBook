void main() {
  final text = """Each day in camp began at 6:30 A.M., when the night watchman drew off a tablespoon of gasoline from a drum in the galley and poured it into a small
